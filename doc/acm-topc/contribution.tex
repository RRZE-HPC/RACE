...
\end{itemize}
We have implemented our graph coloring algorithms in the open source library \acrfull{RACE}\footnote{\href{http://tiny.cc/RACElib}{http://tiny.cc/RACElib}}. {\GW Information required to reproduce the performance numbers provided in this paper is available for download} 
...
This paper is organized as follows: Our experimental setup, the benchmark
matrices, as well as the software and hardware environment are introduced
in \Cref{Sec:test_bed}. In \Cref{Sec:test_kernels} we describe the properties
