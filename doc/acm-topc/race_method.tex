...
by level aggregation in the load balancing step.\GHcomm{load balancing does not change parallelism? I would delete ``in the load balancing step''} In case of our
