...
%We now apply our method recursively to the levels or \levelGroups to identify further paralleism within them.  	
     \begin{figure}[t]
        ...
        \caption{Exposing potential for more parallelism in a graph with \DONE coloring.
          ...
          related to the previous \stex.\GHcomm{Label the levels in (b) and groups in (c)?}}
     	\label{fig:rec_d1_s1}
     \end{figure}
...
rest of the graph since the \DONE coloring step in stage 0 has already made
\levelGroups independent of each other. Now we just need to repeat the three
