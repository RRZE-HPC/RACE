...
\newcommand{\rlmCopy}{19.49}
\newcommand{\rlmLoad}{21.55}
...
\begin{tikzpicture}
  ...
  \addlegendentry{SymmSpMV MC}
   ...
   \addplot+[line width=2, color=color1, mark options={color1}, mark=*, mark size=2pt] table[x =THREAD,y =PERF (GFlop/s),col sep=comma] {\SYMMSPMVRACE}; \label{plot_four}
  \addlegendentry{SymmSpMV RACE}
  
  \addplot+[name path=RLM-copy, mark=square*, mark options={gray}, draw=gray, mark size=2pt] coordinates {(1,\rlmCopy) (12, \rlmCopy) (16, \rlmCopy) (20, \rlmCopy)}; \label{plot_five}
  \addlegendentry{RLM-copy}
  
  	   
  \addplot+[name path=RLM-load,  mark=diamond*, mark options={gray}, draw=gray, mark size=2.5pt ] coordinates {(1,\rlmLoad) (12, \rlmLoad) (16, \rlmLoad) (20, \rlmLoad)}; \label{plot_six}
