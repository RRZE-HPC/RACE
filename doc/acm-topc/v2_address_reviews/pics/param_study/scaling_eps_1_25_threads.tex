...
%First 4 colors generated from http://colorbrewer2.org/#type=qualitative&scheme=Paired&n=4, they are colorblind and print friendly
...
\newcommand{\folder}{data/threads_25}
\begin{document}
	...
	\begin{axis}[ xlabel={\Huge{$\epsilon_0$}}, ylabel={\Huge{$\eta$}},
	...
	tick label style={font=\LARGE} 
		...
		%BEGIN_CODE%
		\pgfplotstableread[col sep=space] {\folder/matrix_inline_1eff_2_50/data/derived.txt} \dimFile
		
		\pgfplotstablegetelem{0}{THREAD}\of\dimFile
		\pgfmathsetmacro{\thread}{\pgfplotsretval}
		
		%MEASURE_START%
		\addplot+[color=color_1, line width=2, mark options={scale=1.8, color_1}] table[x expr=\thisrow{eps_1}*0.01,y =Eff,col sep=space] {\folder/matrix_inline_1eff_2_50/data/derived.txt}; \label{plot_one}
		\addlegendentry{$\epsilon_1=0.50$}
		%MEASURE_STOP%
		...
		%MEASURE_START%
		\addplot+[color=color_4, line width=2, mark options={color_4}, mark=triangle] table[x expr=\thisrow{eps_1}*0.01,y =Eff,col sep=space] {\folder/matrix_inline_1eff_2_90/data/derived.txt}; \label{plot_one}
