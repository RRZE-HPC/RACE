...
%
 \begin{figure}[t]
 	\centering
 	\subfloat[\SKX]{\includegraphics[width=0.95\textwidth, height=0.34\textheight]{pics/results/skx/data_symm_spmv_single_core/plot_generator/perf_vs_mtx_RACE_vs_MKL/perf}}
