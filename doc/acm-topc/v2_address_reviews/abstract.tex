...
approaches substantially. \rDel{ and behaves in accordance with the \roofline
model. Outliers are discussed and analyzed in detail.}
\rAdd{By means of a parameterized \roofline model we analyze the 
 \acrshort{SymmSpMV} performance in detail and discuss outliers.}
