...
\newacronym{nnz}{\mathmacro[N_\mathrm{nz}]}{number of nonzeros}
\newacronym{NNZR}{\mathmacro[N_\mathrm{nzr}]}{average number of nonzeros per row}
\newacronym{SymmNNZR}{\mathmacro[N_\mathrm{nzr}^\mathrm{symm}]}{number of nonzeros per row in symmetric matrix}
