...
by \cite{liu2015spmv} these approaches have drawbacks like missing backward compatibility or matrix conversion costs. 
...
\CAcomm{Another potential way of tackling this inherent data dependency problem is using a \DTWO coloring 
