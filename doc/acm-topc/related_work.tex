...
enclosing iteration scheme.  Interestingly, the hardware-efficient
parallelization of symmetric \Acrshort{SpMV} has not attracted a lot
...
cache-oblivious methods hypergraph partitioning. One
...
in~\cite{li2017hbm,Liu:2015:CES:2751205.2751209,liu2015spmv}.
 ...
 hypergraph partitioning techniques by a cache-oblivious method,
...
in~\cite{Moritz_sell} with a focus on modelling the performance impact
...
computational intensity and irregular accesses to both vectors involved. Typically the
