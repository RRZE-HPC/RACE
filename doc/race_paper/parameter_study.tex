...
\begin{figure}[tbhp]
	...
	\hspace{1.5em}
	\subfloat[Optimal $\epsilon_1$ lowered to 0.4 and $\epsilon_2$ to 0.7, \nthreads=190 ]{\label{fig:inline-d}\includegraphics[width=0.45\textwidth , height=0.2\textheight]{pics/param_study/scaling_eps_1_190_threads}}
...
\begin{figure}[tbhp]
	\centering
	\subfloat[\emph{crankseg\_1}]{\label{fig:crankseg_param}\includegraphics[width=0.46\textwidth , height=0.16\textheight]{pics/param_study/corner_cases/crankseg_1}}
	\hspace{1.5em}
	\subfloat[\emph{inline\_1}]{\label{fig:inline_param}\includegraphics[width=0.46\textwidth , height=0.16\textheight]{pics/param_study/corner_cases/inline_1}}	
	\hspace{1.5em}
	\subfloat[\emph{parabolic\_fem}]{\label{fig:parabolic_fem_param}\includegraphics[width=0.46\textwidth , height=0.16\textheight]{pics/param_study/corner_cases/parabolic_fem}}
	\hspace{1.5em}
	\subfloat[\emph{Graphene-4096}]{\label{fig:Graphene-4096_param}\includegraphics[width=0.46\textwidth , height=0.16\textheight]{pics/param_study/corner_cases/Graphene-4096}}	
...
\end{figure}
 ...
 In \cref{fig:corner_cases_param} we have plotted \threadEff and $\eta$ vs \nthreads for corner case matrices with the settings used in experiment runs. Here we set $\epsilon_{1,2}=0.8$ and use \RCM (\RCMfull) in the \emph{level construction} stage (\cref{subsec:LEVEL_CONST}). Big fluctuation in \emph{crankseg\_1} is due to the fact that we set high load balancing requirement (high $\epsilon_s$ factor) and as seen in the example of \emph{inline\_1} matrix this is not optimal when we reach the limit of parallelism. The theoretical estimated obtained in \cref{fig:corner_cases_param} will be directly used to compare with experiment runs in the next section (\cref{Sec:expt}).
