...
\begin{figure}[tbp]
	...
	\caption{Attained bandwidth vs total data size for range from 20 \MB to 2 \GB. The dotted lines show the asymptotic bandwidth shown in \cref{tab:test_bed} for the load and copy benchmark.}
