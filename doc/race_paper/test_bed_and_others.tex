...
\begin{table}[htbp]
	\footnotesize
	\caption{Optimal $\alpha_{\acrshort{SpMV}}$ value along with values measured using \LIKWID on \SKX (SKX) and \IVB (IVB) respectively. The optimal intensity of \acrshort{SpMV} ($I_{\acrshort{SpMV}}(\alpha_{SpMV})$) is also shown.}
