...
\begin{figure}[thbp]
	\centering
	\subfloat[RACE performance compared to SpMV]{\label{fig:race_ivy}\includegraphics[width=0.45\textwidth, height=0.15\textheight]{pics/results/ivy/race}}
	\hspace{1.2em}
	\subfloat[SymmSpMV Comparison]{\label{fig:symm_spmv_ivy}\includegraphics[width=0.45\textwidth, height=0.15\textheight]{pics/results/ivy/symm_spmv}}
	\hspace{1.2em}
	\subfloat[GS Comparison]{\label{fig:gs_ivy}\includegraphics[width=0.45\textwidth, height=0.15\textheight]{pics/results/ivy/gs}}
	\hspace{1.2em}
	\subfloat[KACZ Comparison]{\label{fig:kacz_ivy}\includegraphics[width=0.45\textwidth, height=0.15\textheight]{pics/results/ivy/kacz}}
...
\subsubsection{Comparison exact kernel}
...
\begin{figure}[thbp]
	\centering
	\subfloat[\SYMMGS iterations required by different methods compared to exact MKL kernel] {\label{fig:iter_gs}\includegraphics[width=0.45\textwidth, height=0.15\textheight]{pics/results/skx/iter/gs/plot}}
	\hspace{1.2em}
	\subfloat[\SYMMKACZ iterations required by different methods compared to exact Serial kernel] {\label{fig:iter_kacz}\includegraphics[width=0.45\textwidth, height=0.15\textheight]{pics/results/skx/iter/kacz/plot}}
...
Here we compare  \RACE with \ABMC, \MC and \MKL for \GS and \KACZ. Here we include iterations also in performance metric. \Cref{fig:gs_ivy,fig:kacz_ivy,fig:gs_skx,fig:kacz_skx} will be used. Actual iteration behavior can be seen in \cref{fig:conv_behavior}.
...
\begin{figure}[thbp]
	\centering
	\subfloat[Comparison of \RACE with \RSB on \IVB] {\label{fig:race_vs_rsb_ivy}\includegraphics[width=0.45\textwidth, height=0.15\textheight]{pics/results/ivy/race_vs_rsb}}
	\hspace{1.2em}
	\subfloat[Comparison of \RACE with \RSB on \SKX] {\label{fig:race_vs_rsb_skx}\includegraphics[width=0.45\textwidth, height=0.15\textheight]{pics/results/skx/race_vs_rsb}}
