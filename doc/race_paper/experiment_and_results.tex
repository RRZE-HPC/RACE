...
\begin{figure}[thbp]
	\centering
	\subfloat[\SymmSpmv on 1 socket of \IVB]{\label{fig:symm_spmv_ivy}\includegraphics[width=0.48\textwidth, height=0.15\textheight]{pics/results/ivy/symm_spmv/symm_spmv}}
	\hspace{1em}
	\subfloat[\SymmSpmv on 1 socket of \SKX]{\label{fig:symm_spmv_skx}\includegraphics[width=0.48\textwidth, height=0.15\textheight]{pics/results/skx/symm_spmv/symm_spmv}}
...
\begin{figure}[thbp]
	\centering
	\subfloat[1 socket \IVB] {\label{fig:derived_perf_kacz_ivb}\includegraphics[width=0.48\textwidth, height=0.15\textheight]{pics/results/ivy/kacz/derived_perf}}
	\hspace{1em}
	\subfloat[1 socket \SKX] {\label{fig:derived_perf_kacz_skx}\includegraphics[width=0.48\textwidth, height=0.15\textheight]{pics/results/skx/kacz/derived_perf}}
...
\begin{figure}[thbp]
	\centering
	\subfloat[Plain performance] {\label{fig:perf_kacz_ivb}\includegraphics[width=0.48\textwidth, height=0.15\textheight]{pics/results/skx/kacz/perf}}
	\hspace{1em}
	\subfloat[Iterations compared to serial Symm\KACZ kernel] {\label{fig:iter_kacz_skx}\includegraphics[width=0.48\textwidth, height=0.15\textheight]{pics/results/skx/kacz/iter}}
