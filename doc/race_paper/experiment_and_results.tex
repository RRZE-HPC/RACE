...
\Cref{fig:SpMV_vs_SymmSpMV} provides performance of SymmSpMV compared to SpMV, where one can get an idea of how close we can reach near ideal performance. TODO provide RLM for each matrices. 
