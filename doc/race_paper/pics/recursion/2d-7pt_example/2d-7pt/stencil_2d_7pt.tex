...
\def\size{15} %size-1
\begin{document}
	\begin{tikzpicture}[redstyle/.style={circle,draw,fill=red!30!white,minimum size=32, inner sep=0.2pt}, bluestyle/.style={circle,draw,fill=blue!30!white,minimum size=32, inner sep=0.2pt}, amberstyle/.style={circle,draw,fill=amber!60!white,minimum size=32, inner sep=0.2pt}, magentastyle/.style={circle,draw,fill=magenta!60!white,minimum size=32, inner sep=0.2pt}, carminestyle/.style={circle,draw,fill=carmine!60!white,minimum size=32, inner sep=0.2pt}, cyanstyle/.style={circle,draw,fill=cyan!60!white,minimum size=32, inner sep=0.2pt}]
	\foreach \x in {0,...,\size}
	\foreach \y in {0,...,\size} 
	{
	...
	\draw [color=red,dashed, line width=1mm, fill=red, fill opacity=0.2, rounded corners=5mm] (16.5, -0.8) -- (19.5,-0.8) -- (-1,19.75) -- (-1,16.75) -- (16.5, -0.8);
	
	\node[red] at (18, -1.5) {\Huge{$T_0(4)$}};
	\end{tikzpicture}
