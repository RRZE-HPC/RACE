...
%	title = {\LARGE{$n\_threads$ vs $\eta$ , matrix - \emph{inline\_1}, $\epsilon_2 = 40$} },
	...
	%MEASURE_START%
	\addplot+[color=color_1, line width=2, mark options={color_1}] table[x =THREAD,y =Eff,col sep=space] {/home/christiealappatt/Thesis/race_performance/RACE_paper_results/param_study/db/matrix_inline_1/eff_1_40/eff_2_40//derived.txt}; \label{plot_one}
	\addlegendentry{$\epsilon_0 = 0.40$}
	%MEASURE_STOP%
	...
	%MEASURE_START%
	\addplot+[color=color_2, line width=2, mark options={color_2}] table[x =THREAD,y =Eff,col sep=space] {/home/christiealappatt/Thesis/race_performance/RACE_paper_results/param_study/db/matrix_inline_1/eff_1_70/eff_2_40//derived.txt}; \label{plot_two}
	...
	%MEASURE_START%
	\addplot+[color=color_3, line width=2, mark options={color_3}] table[x =THREAD,y =Eff,col sep=space] {/home/christiealappatt/Thesis/race_performance/RACE_paper_results/param_study/db/matrix_inline_1/eff_1_80/eff_2_40//derived.txt}; \label{plot_three}
