...
%	title = {\LARGE{$\epsilon_1$ vs $\eta$ , matrix - \emph{inline\_1}, $n\_threads = 190$}},
	...
	tick label style={font=\Large} 
		...
		%MEASURE_START%
		\addplot+[color=color_1, line width=2, mark options={scale=1.8, color_1}] table[x =eps_1,y =Eff,col sep=space] {\folder/matrix_inline_1eff_2_40/data/derived.txt}; \label{plot_one}
		...
		%MEASURE_START%
		\addplot+[color=color_2, line width=2, mark options={scale=1.25,color_2}] table[x =eps_1,y =Eff,col sep=space] {\folder/matrix_inline_1eff_2_70/data/derived.txt}; \label{plot_one}
		...
		%MEASURE_START%
		\addplot+[color=color_3, line width=2, mark options={color_3}] table[x =eps_1,y =Eff,col sep=space] {\folder/matrix_inline_1eff_2_80/data/derived.txt}; \label{plot_one}
		...
		%MEASURE_START%
		\addplot+[color=color_4, line width=2, mark options={color_4}] table[x =eps_1,y =Eff,col sep=space] {\folder/matrix_inline_1eff_2_90/data/derived.txt}; \label{plot_one}
