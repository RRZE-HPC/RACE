...
\begin{tikzpicture}
  ...
  \addplot+[name path=RLM-copy, mark=square*, mark options={gray}, draw=gray] coordinates {(1,\rlmCopy) (6, \rlmCopy) (8, \rlmCopy) (10, \rlmCopy)}; \label{plot_five}
  \addlegendentry{RLM-copy}
  
  	   
  \addplot+[name path=RLM-load,  mark=diamond*, mark options={gray}, draw=gray ] coordinates {(1,\rlmLoad) (6, \rlmLoad) (8, \rlmLoad) (10, \rlmLoad)}; \label{plot_six}
