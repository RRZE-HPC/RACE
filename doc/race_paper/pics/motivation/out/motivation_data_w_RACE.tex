...
\begin{document}
	...
	\pgfmathsetmacro{\NNZ}{\pgfplotsretval}
		...
		coordinates {(SpMV,\memSPMV) (SymmSpMV-MC,\memSYMMSPMVMC) (SymmSpMV-ABMC,\memSYMMSPMVABMC) (SymmSpMV-RACE,\memSYMMSPMVRACE)};
		...
		\addplot[draw=red,smooth,dashed, line width=3pt] coordinates { (SymmSpMV-MC,\ideal) (SymmSpMV-ABMC,\ideal) (SymmSpMV-RACE,\ideal)};
				
		\legend{MEM, L3, L2, Ideal SymmSpMV}
		\addplot[draw=red,smooth,dashed, line width=3pt, shorten >=-2em, shorten <=-2em] coordinates { (SymmSpMV-MC,\ideal) (SymmSpMV-RACE,\ideal)};
		\end{axis}
