...
\begin{document}
	...
	\pgfmathsetmacro{\NNZ}{\pgfplotsretval}
		...
		symbolic x coords={SpMV, SymmSpMV-MC, SymmSpMV-ABMC, SymmSpMV-RAC},
		...
		coordinates {(SpMV,\memSPMV) (SymmSpMV-MC,\memSYMMSPMVMC) (SymmSpMV-ABMC,\memSYMMSPMVABMC) (SymmSpMV-RAC,\memSYMMSPMVRACE)};
		...
		\addplot[draw=red,smooth,dashed, line width=3pt] coordinates { (SymmSpMV-MC,\ideal) (SymmSpMV-ABMC,\ideal) (SymmSpMV-RAC,\ideal)};
