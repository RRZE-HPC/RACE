...
\begin{document}
	...
	\pgfmathsetmacro{\NNZ}{\pgfplotsretval}
		...
		symbolic x coords={SpMV, SpMV-MC, SpMV-ABMC, SymmSpMV-MC, SymmSpMV-ABMC},
		x tick label style={rotate=35,font={\arge}},
		...
		coordinates {(SpMV,\memSPMV) (SpMV-MC,\memSPMVMC) (SpMV-ABMC,\memSPMVABMC) (SymmSpMV-MC,\memSYMMSPMVMC) (SymmSpMV-ABMC,\memSYMMSPMVABMC)};
