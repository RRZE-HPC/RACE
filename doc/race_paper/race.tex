...
\newcommand{\totalLvl}{$total\_level$\xspace}
...
\newcommand{\nrows}{${nrows}$\xspace}
\newcommand{\nnz}{${nnz}$\xspace}
\newcommand{\nrowsEff}{${eff_{row}}$\xspace}
\newcommand{\nrowsEffMath}{eff_{row}\xspace}
\newcommand{\threadEff}{${eff_{thread}}$\xspace}
\newcommand{\threadEffMath}{{eff_{thread}}\xspace}
\begin{document}
