...
\begin{document}
	...
	\author{Christie Louis Alappat} \authornote{Friedrich-Alexander-Universit{\"a}t
	...
	\author{Advisors : Gerhard Wellein\textsuperscript{*}, Georg
		Hager\textsuperscript{*}, Olaf Schenk } \authornote{Institute of Computational
		Science, Lugano, Switzerland}
