...
\scalebox{0.7}{\begin{tikzpicture}
	...
	\fill[white] (8,\x) rectangle (9,\x+1);  
	\draw[step=1cm,black,very thin] (8,-0) grid (9,7);
	\node at (8.5,6.5-\colperm[0]) {\Large{}}; 
	\node at (8.5,6.5-\colperm[1]) {\Large{}}; 
	\node at (8.5,6.5-\colperm[2]) {\Large{}}; 
	\node at (8.5,6.5-\colperm[3]) {\Large{}}; 
	\node at (8.5,6.5-\colperm[4]) {\Large{}}; 
	\node at (8.5,6.5-\colperm[5]) {\Large{}}; 
	\node at (8.5,6.5-\colperm[6]) {\Large{}}; 
\end{tikzpicture}}
%\end{minipage}
%\end{document}
