...
them consists of at most $k$ edges \cite{dist_k_def}. This implies two vertices
 ...
 %\setlength{\belowcaptionskip}{-12pt}
 \begin{figure}[b]
 	\subfloat[\DONE coloring]{\label{fig:d1_color}\includegraphics[scale=0.35]{pics/race_method/d1_color}}
 	\subfloat[\DTWO coloring]{\label{fig:d2_color}\includegraphics[scale=0.35]{pics/race_method/d2_color}}
