...
subprogram.  \acrshort{SpMV} is a bandwidth-limited operation and, on
...
Despite \acrshort{SpMV} being a bandwidth-limited operation there has
been not much work in the direction of optimizing storage and data transfer 
of symmetric matrices by using the \acrfull{SymmSpMV} operation. This
...
other optimization strategies is orthogonal to the method. The \acrshort{MC} approach
