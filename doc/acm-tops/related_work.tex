...
arrays~\cite{sparseX,thread_private_symm_spmv,Krotkiewski:2010:PSS:1752612.1752682}. However they have in common that their overhead may increase with degree of parallelism.
...
Widely used and public available coloring packages such as COLPACK and ZOLTAN also aim to speed-up the coloring process by parallelization and other heuristics. 
